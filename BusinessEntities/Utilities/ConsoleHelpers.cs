...
namespace BusinessEntities.Utilities
{
    public static class ConsoleHelpers
    {
        public static void Print<T>(IReadOnlyList<string> rowHeaders, IReadOnlyList<string> colHeaders, T[,] values, string formatString = "{0}")
        {
            if (rowHeaders == null)
